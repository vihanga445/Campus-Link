...
const AboutUs = () => {
  return (
    <div className="bg-blue-50 dark:bg-gray-900 text-gray-900 dark:text-white">
      ...
      >
        <div className="absolute inset-0 bg-blue-900 opacity-70 dark:bg-black dark:opacity-90"></div> {/* Reduced opacity */}
        <div className="relative flex items-center justify-center h-full text-center">
          <div>
            <h1 className="text-5xl font-bold"><u>About Us</u></h1>
            <p className="mt-4 text-xl font-semibold">Welcome to CampusLink, where we connect students across the campus.</p>
            <div className="mt-6">
      ...
      <section id="who-we-are" className="py-16 bg-white dark:bg-gray-800">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="grid grid-cols-1 md:grid-cols-2 gap-8">
            <div>
              <h2 className="text-3xl font-bold text-blue-900 dark:text-white">Behind the Project</h2>
      ...
      <section className="py-16 bg-white dark:bg-gray-800">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <h2 className="text-3xl font-bold text-blue-900 dark:text-white text-center">The Journey So Far</h2>
          <div className="mt-10">
      ...
      <section className="py-16 bg-blue-100 dark:bg-gray-900">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 text-center">
          <h2 className="text-3xl font-bold text-blue-900 dark:text-white">Our Department</h2>
          <p className="mt-4 text-lg text-gray-600 dark:text-gray-300">
