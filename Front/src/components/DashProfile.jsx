...
{/* Hover overlay for changing cover photo */}
      ...
      <div className="relative w-40 h-40 border-4 border-white rounded-full shadow-md overflow-hidden cursor-pointer" onClick={() => filePickerRef.current.click()}>
        <img             src={imageFileUrl || currentUser.profilePicture || defaultProfilePicture}
            alt="Profile"
